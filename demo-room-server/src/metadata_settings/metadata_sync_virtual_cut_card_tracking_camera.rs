...
#[namespace(
    ...
    rename = "SyncVirtualCutCardTrackingCamera"
)]
#[derive(Deserialize, Clone)]
pub struct MetadataSyncVirtualCutCardTrackingCamera {}

settings_wrapper_register!(
    MetadataSyncVirtualCutCardTrackingCamera as MetadataNetworkBehaviourWrapper
);
